...
CREATE TABLE `sc` (
  ...
  KEY `fk_sc_student_idx` (`sid`),
  KEY `fk_sc_course_idx` (`cid`),
  CONSTRAINT `fk_sc_course` FOREIGN KEY (`cid`) REFERENCES `course` (`cid`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_sc_student` FOREIGN KEY (`sid`) REFERENCES `student` (`sid`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2019-03-13  8:19:43